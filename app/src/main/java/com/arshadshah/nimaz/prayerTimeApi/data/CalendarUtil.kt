...
object CalendarUtil
{
    ...
    /**
     * Date and time with a rounded minute This returns a date with the seconds
     * rounded and added to the minute
     *
     * @param when the date and time
     * @return the date and time with 0 seconds and minutes including rounded
     * seconds
     */
    @JvmStatic
