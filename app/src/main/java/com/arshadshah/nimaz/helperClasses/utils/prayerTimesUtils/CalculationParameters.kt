 ...
 *
 * Note that, for many cases, you can use
 * [CalculationMethod.getParameters] to get a pre-computed set of
 * calculation parameters depending on one of the available
 * [CalculationMethod].
 */
